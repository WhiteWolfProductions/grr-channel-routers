/**
 * grr-channel-router — Grassroots Rodeo Channel 6
...
const CHANNEL_CONFIG = {
  channelId: '6',
  name: 'BarChannel 1 - Grassroots Rodeo',
  playoutUrl: 'https://www2.grassrootsrodeo.com/api/channels/6/live',
...
export default {
  async fetch(request, env, ctx) {
    ...
    //    Static .m3u8 index files. When we move to a real livestream with
    //    dynamically changing manifests, those will use a different channel/worker.
